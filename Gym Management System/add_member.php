...
<div class="container">
    ...
    ?>
		<label class="mt-3"><b>MEMBER ID</b></label>
		<input type="text" name="id" class="form-control">
		<label class="mt-3"><b>MEMBER NAME</b></label>
		<input type="text" name="name" class="form-control">
		<label class="mt-3"><b>AGE</b></label>
		...
		<label class="mt-3"><b>MOBILE NO</b></label>
		<input type="text" name="mobileno" class="form-control">
		<label class="mt-3"><b>PAYMENT AREA ID</b></label>
		<input type="text" name="pay_id" class="form-control">
		<label class="mt-3"><b>TRAINER ID</b></label>
